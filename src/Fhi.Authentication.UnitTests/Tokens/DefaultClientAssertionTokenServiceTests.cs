...
namespace Fhi.Authentication.UnitTests.Tokens
{
    public class DefaultClientAssertionTokenServiceTests
    {
        ...
        {
            var service = new DefaultClientAssertionTokenHandler();
            var token = service.CreateJwtToken("issuer", "clientId", "");
        }
    }
}